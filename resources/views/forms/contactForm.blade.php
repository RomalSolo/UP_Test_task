                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control @error('fullname') is-invalid @enderror" name="fullname" value="{{ Auth::user()->name }}" required autocomplete="Fullname" autofocus>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ isset(Auth::user()->email) ? Auth::user()->email : '' }}" required autocomplete="email" autofocus>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-form-label text-md-right">{{ __('Attach File') }}</label>

                                        <input type="file" accept="image/*" class="form-control @error('attachment') is-invalid @enderror" name="attachment" autofocus>
